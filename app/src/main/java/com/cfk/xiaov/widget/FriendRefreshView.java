...
public class FriendRefreshView extends ViewGroup implements OnDetectScrollListener {
    ...
    private void initRainbowView() {
        ...
        mRainbowView.setImageResource(com.cfk.xiaov.R.mipmap.rainbow_ic);
    ...
    private void initListView() {
        ...
        View mHeadViw = LayoutInflater.from(getContext()).inflate(com.cfk.xiaov.R.layout.list_head_layout, null);
