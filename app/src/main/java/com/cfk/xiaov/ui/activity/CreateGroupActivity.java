...
import com.cfk.xiaov.ui.presenter.CreateGroupAtPresenter;
import com.cfk.xiaov.ui.view.ICreateGroupAtView;
...
public class CreateGroupActivity extends BaseActivity<ICreateGroupAtView, CreateGroupAtPresenter> implements ICreateGroupAtView {
    ...
    @Bind(com.cfk.xiaov.R.id.rvSelectedContacts)
    LQRRecyclerView mRvSelectedContacts;
    @Bind(com.cfk.xiaov.R.id.etKey)
    EditText mEtKey;
    ...
    public void initView() {
        ...
        mBtnToolbarSend.setText(UIUtils.getString(com.cfk.xiaov.R.string.sure));
        mBtnToolbarSend.setEnabled(false);
        mHeaderView = View.inflate(this, com.cfk.xiaov.R.layout.header_group_cheat, null);
    }
    ...
    public void initListener() {
        ...
        mHeaderView.findViewById(com.cfk.xiaov.R.id.tvSelectOneGroup).setOnClickListener(v -> UIUtils.showToast("选择一个群"));
    ...
    protected int provideContentViewId() {
        return com.cfk.xiaov.R.layout.activity_create_group;
    }
