...
public class AutoToolbar extends Toolbar {
    ...
    public AutoToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.cfk.xiaov.R.styleable.Toolbar,
                defStyleAttr, com.cfk.xiaov.R.style.Widget_AppCompat_Toolbar);

        int titleTextAppearance = a.getResourceId(com.cfk.xiaov.R.styleable.Toolbar_titleTextAppearance,
                com.cfk.xiaov.R.style.TextAppearance_Widget_AppCompat_Toolbar_Title);

        int subtitleTextAppearance = a.getResourceId(com.cfk.xiaov.R.styleable.Toolbar_subtitleTextAppearance,
                com.cfk.xiaov.R.style.TextAppearance_Widget_AppCompat_Toolbar_Subtitle);
...
//        menuA.recycle();
    ...
    private int loadTextSizeFromTextAppearance(int textAppearanceResId) {
        TypedArray a = getContext().obtainStyledAttributes(textAppearanceResId,
                com.cfk.xiaov.R.styleable.TextAppearance);
        try {
            if (!DimenUtils.isPxVal(a.peekValue(com.cfk.xiaov.R.styleable.TextAppearance_android_textSize)))
                return NO_VALID;
            return a.getDimensionPixelSize(com.cfk.xiaov.R.styleable.TextAppearance_android_textSize, NO_VALID);
        } finally {
            a.recycle();
        }
    }
