    ...
    private void initView(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs,
                    com.cfk.xiaov.R.styleable.BubbleImageView);
            mAngle = (int) a.getDimension(
                    com.cfk.xiaov.R.styleable.BubbleImageView_bubble_angle, mAngle);
            mArrowHeight = (int) a.getDimension(
                    com.cfk.xiaov.R.styleable.BubbleImageView_bubble_arrowHeight,
                    mArrowHeight);
            mArrowOffset = (int) a.getDimension(
                    com.cfk.xiaov.R.styleable.BubbleImageView_bubble_arrowOffset,
                    mArrowOffset);
            mArrowTop = (int) a.getDimension(
                    com.cfk.xiaov.R.styleable.BubbleImageView_bubble_arrowTop, mArrowTop);
            mArrowWidth = (int) a.getDimension(
                    com.cfk.xiaov.R.styleable.BubbleImageView_bubble_arrowWidth, mAngle);
            mArrowLocation = a.getInt(
                    com.cfk.xiaov.R.styleable.BubbleImageView_bubble_arrowLocation,
                    mArrowLocation);
            mShowText = a.getBoolean(com.cfk.xiaov.R.styleable.BubbleImageView_bubble_showText, mShowText);
            mShowShadow = a.getBoolean(com.cfk.xiaov.R.styleable.BubbleImageView_bubble_showShadow, mShowShadow);
            a.recycle();
        }
    }
