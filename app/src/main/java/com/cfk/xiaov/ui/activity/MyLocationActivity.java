...
import com.cfk.xiaov.ui.presenter.MyLocationAtPresenter;
import com.cfk.xiaov.ui.view.IMyLocationAtView;
...
public class MyLocationActivity extends BaseActivity<IMyLocationAtView, MyLocationAtPresenter> implements IMyLocationAtView, TencentLocationListener, SensorEventListener {
    ...
    @Bind(com.cfk.xiaov.R.id.rlMap)
    RelativeLayout mRlMap;
    @Bind(com.cfk.xiaov.R.id.map)
    MapView mMap;
    @Bind(com.cfk.xiaov.R.id.ibShowLocation)
    ImageButton mIbShowLocation;
    @Bind(com.cfk.xiaov.R.id.rvPOI)
...
//        mSensorManager.registerListener(MyLocationActivity.this, mOritationSensor, SensorManager.SENSOR_DELAY_NORMAL);
    ...
    protected int provideContentViewId() {
        return com.cfk.xiaov.R.layout.activity_my_location;
    }
    ...
    public void onLocationChanged(TencentLocation tencentLocation, int i, String s) {
        if (i == tencentLocation.ERROR_OK) {
            ...
            if (myLocation == null) {
                myLocation = mTencentMap.addMarker(new MarkerOptions().position(latLng).icon(BitmapDescriptorFactory.fromResource(com.cfk.xiaov.R.mipmap.arm)).anchor(0.5f, 0.8f));
            }
            if (accuracy == null) {
