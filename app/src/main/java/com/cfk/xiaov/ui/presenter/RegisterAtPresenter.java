...
public class RegisterAtPresenter extends BasePresenter<IRegisterAtView> {
    ...
    public void sendCode() {
        ...
        if (!RegularUtils.isMobile(phone)) {
            UIUtils.showToast(UIUtils.getString(com.cfk.xiaov.R.string.phone_format_error));
            return;
        }
        ...
        ApiRetrofit.getInstance().checkPhoneAvailable(AppConst.REGION, phone)
                ...
                .flatMap(new Func1<CheckPhoneResponse, Observable<SendCodeResponse>>() {
                    ...
                    public Observable<SendCodeResponse> call(CheckPhoneResponse checkPhoneResponse) {
                        ...
                        if (code == 200) {
                            ...
                            return Observable.error(new ServerException(UIUtils.getString(com.cfk.xiaov.R.string.phone_not_available)));
                        }
                    }
                })
                ...
                .subscribe(sendCodeResponse -> {
                    ...
                    if (code == 200) {
                        ...
                        sendCodeError(new ServerException(UIUtils.getString(com.cfk.xiaov.R.string.send_code_error)));
                    }
                }, this::sendCodeError);
    }
                ...
                .subscribe(time -> {
                    if (getView().getBtnSendCode() != null) {
                        if (time >= 0) {
                            ...
                            getView().getBtnSendCode().setText(UIUtils.getString(com.cfk.xiaov.R.string.send_code_btn_normal_tip));
                        }
                    } else {
                        mTimer.cancel();
                    }
    ...
    public void register() {
        ...
        if (TextUtils.isEmpty(code)) {
            UIUtils.showToast(UIUtils.getString(com.cfk.xiaov.R.string.vertify_code_not_empty));
            return;
        }
                ...
                .flatMap(new Func1<VerifyCodeResponse, Observable<RegisterResponse>>() {
                    ...
                    public Observable<RegisterResponse> call(VerifyCodeResponse verifyCodeResponse) {
                        ...
                        if (code == 200) {
                            ...
                            return Observable.error(new ServerException(UIUtils.getString(com.cfk.xiaov.R.string.vertify_code_error) + code));
                        }
                    }
                })
