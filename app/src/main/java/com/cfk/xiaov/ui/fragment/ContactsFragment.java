...
import com.cfk.xiaov.ui.activity.GroupListActivity;
...
import com.cfk.xiaov.ui.activity.NewFriendActivity;
import com.cfk.xiaov.ui.presenter.ContactsFgPresenter;
import com.cfk.xiaov.util.UIUtils;
import com.cfk.xiaov.widget.QuickIndexBar;
...
public class ContactsFragment extends BaseFragment<IContactsFgView, ContactsFgPresenter> implements IContactsFgView {
    ...
    @Bind(com.cfk.xiaov.R.id.rvContacts)
    LQRRecyclerView mRvContacts;
    @Bind(com.cfk.xiaov.R.id.qib)
    QuickIndexBar mQib;
    @Bind(com.cfk.xiaov.R.id.tvLetter)
    TextView mTvLetter;
    ...
    public void initView(View rootView) {
        mHeaderView = View.inflate(getActivity(), com.cfk.xiaov.R.layout.header_rv_contacts, null);
        mTvNewFriendUnread = (TextView) mHeaderView.findViewById(com.cfk.xiaov.R.id.tvNewFriendUnread);
    ...
    public void initListener() {
        mHeaderView.findViewById(com.cfk.xiaov.R.id.llNewFriend).setOnClickListener(v -> {
        ...
        mHeaderView.findViewById(com.cfk.xiaov.R.id.llGroup).setOnClickListener(v -> ((MainActivity) getActivity()).jumpToActivity(GroupListActivity.class));
    ...
    protected int provideContentViewId() {
        return com.cfk.xiaov.R.layout.fragment_contacts;
    }
