...
//        }
    ...
    public Dialog showWaitingDialog(String tip) {
        hideWaitingDialog();
        View view = View.inflate(this, com.cfk.xiaov.R.layout.dialog_waiting, null);
        if (!TextUtils.isEmpty(tip))
            ((TextView) view.findViewById(com.cfk.xiaov.R.id.tvTip)).setText(tip);
        mDialogWaiting = new CustomDialog(this, view, com.cfk.xiaov.R.style.MyDialog);
        mDialogWaiting.show();
