...
import com.cfk.xiaov.ui.presenter.SearchUserAtPresenter;
...
public class SearchUserActivity extends BaseActivity<ISearchUserAtView, SearchUserAtPresenter> implements ISearchUserAtView {
    ...
    @Bind(com.cfk.xiaov.R.id.llToolbarSearch)
    LinearLayout mLlToolbarSearch;
    @Bind(com.cfk.xiaov.R.id.etSearchContent)
    EditText mEtSearchContent;

    @Bind(com.cfk.xiaov.R.id.rlNoResultTip)
    RelativeLayout mRlNoResultTip;
    @Bind(com.cfk.xiaov.R.id.llSearch)
    LinearLayout mLlSearch;
    @Bind(com.cfk.xiaov.R.id.tvMsg)
    TextView mTvMsg;
    ...
    protected int provideContentViewId() {
        return com.cfk.xiaov.R.layout.activity_search_user;
    }
