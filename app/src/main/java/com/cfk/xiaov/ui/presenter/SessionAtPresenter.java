...
import com.cfk.xiaov.model.data.LocationData;
import com.cfk.xiaov.model.message.RedPacketMessage;
import com.cfk.xiaov.ui.activity.SessionActivity;
import com.cfk.xiaov.ui.activity.ShowBigImageActivity;
import com.cfk.xiaov.ui.adapter.SessionAdapter;
import com.cfk.xiaov.ui.base.BaseFragmentActivity;
import com.cfk.xiaov.ui.base.BaseFragmentPresenter;
import com.cfk.xiaov.util.FileOpenUtils;
...
import com.cfk.xiaov.ui.view.ISessionAtView;
    ...
    public void setAdapter() {
        if (mAdapter == null) {
            ...
            mAdapter.setOnItemClickListener((helper, parent, itemView, position) -> {
                ...
                if (content instanceof ImageMessage) {
                    ...
                    if (MediaFileUtils.isVideoFileType(fileMessage.getName())) {
                        helper.getView(com.cfk.xiaov.R.id.bivPic).setOnClickListener(v -> {
                            ...
                            if (isSend) {
                                ...
                                if (receivedStatus.isDownload() || receivedStatus.isRetrieved()) {
                                    if (fileMessage.getLocalPath() != null) {
                                        ...
                                        UIUtils.showToast(UIUtils.getString(com.cfk.xiaov.R.string.file_out_of_date));
                                    }
                                } else {
                                    downloadMediaMessage(message);
                                }
                    ...
                    final ImageView ivAudio = helper.getView(com.cfk.xiaov.R.id.ivAudio);
            ...
            mAdapter.setOnItemLongClickListener((helper, viewGroup, view, position) -> {
                View sessionMenuView = View.inflate(mContext, com.cfk.xiaov.R.layout.dialog_session_menu, null);
                mSessionMenuDialog = new CustomDialog(mContext, sessionMenuView, com.cfk.xiaov.R.style.MyDialog);
                TextView tvReCall = (TextView) sessionMenuView.findViewById(com.cfk.xiaov.R.id.tvReCall);
                TextView tvDelete = (TextView) sessionMenuView.findViewById(com.cfk.xiaov.R.id.tvDelete);
                ...
                tvReCall.setOnClickListener(v -> RongIMClient.getInstance().recallMessage(message, "", new RongIMClient.ResultCallback<RecallNotificationMessage>() {
                    ...
                    public void onSuccess(RecallNotificationMessage recallNotificationMessage) {
                        UIUtils.postTaskSafely(() -> {
                            ...
                            UIUtils.showToast(UIUtils.getString(com.cfk.xiaov.R.string.recall_success));
                        });
                    }
                    ...
                    public void onError(RongIMClient.ErrorCode errorCode) {
                        UIUtils.postTaskSafely(() -> {
                            mSessionMenuDialog.dismiss();
                            mSessionMenuDialog = null;
                            UIUtils.showToast(UIUtils.getString(com.cfk.xiaov.R.string.recall_fail) + ":" + errorCode.getValue());
                        });
                    }
                }));
                tvDelete.setOnClickListener(v -> RongIMClient.getInstance().deleteMessages(new int[]{message.getMessageId()}, new RongIMClient.ResultCallback<Boolean>() {
                    ...
                    public void onSuccess(Boolean aBoolean) {
                        UIUtils.postTaskSafely(() -> {
                            ...
                            mAdapter.notifyDataSetChangedWrapper();
                            UIUtils.showToast(UIUtils.getString(com.cfk.xiaov.R.string.delete_success));
                        });
                    }
                    ...
                    public void onError(RongIMClient.ErrorCode errorCode) {
                        UIUtils.postTaskSafely(() -> {
                            mSessionMenuDialog.dismiss();
                            mSessionMenuDialog = null;
                            UIUtils.showToast(UIUtils.getString(com.cfk.xiaov.R.string.delete_fail) + ":" + errorCode.getValue());
                        });
                    }
                }));
    ...
    public void sendAudioFile(Uri audioPath, int duration) {
        if (audioPath != null) {
            ...
            if (!file.exists() || file.length() == 0L) {
                LogUtils.sf(UIUtils.getString(com.cfk.xiaov.R.string.send_audio_fail));
                return;
            }
